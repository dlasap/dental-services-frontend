...
export default function Booking() {
  ...
  return (
    <div className="w-full flex justify-evenly flex-wrap lg:pr-12 pr-2 lg:m-8 gap-2 m-2">
        ...
        <div className="flex gap-3 flex-wrap justify-center">
          <div className="slide-right-containers choose-service">
            <h3 className="bg-primary font-bold text-xl p-2 text-white flex-grow-1">
              ...
              <FontAwesomeIcon
                icon={faCircleCheck}
                className={cn("ml-2", selectedService && "text-green-400")}
              />
            </h3>
          ...
          <div className="slide-right-containers choose-doctor">
            <h3 className="bg-primary font-bold text-xl py-2 px-4 text-white">
              ...
              <FontAwesomeIcon
                icon={faCircleCheck}
                className={cn("ml-2", selectedDoctor && "text-green-200")}
              />
            </h3>
            <DentistsList
          ...
          <div className="bg-white h-fit rounded-md slide-right-containers choose-schedule">
            <h3 className="bg-primary font-bold text-xl py-2 text-white">
              ...
              <FontAwesomeIcon
                icon={faCircleCheck}
                className={cn("ml-2", selectedDate && "text-green-400")}
              />
            </h3>
            <Calendar
              className="px-8"
          ...
          <div className="bg-white h-fit rounded-md slide-right-containers choose-time">
            <h3 className="bg-primary font-bold text-xl text-white p-2">
              ...
              <FontAwesomeIcon
                icon={faCircleCheck}
                className={cn("ml-2", selectedScheduleTime && "text-green-400")}
              />
            </h3>
      ...
      <div className="lg:min-w-[400px] max-w-[530px]">
        {selectedService &&
          selectedDoctor &&
          selectedDate &&
